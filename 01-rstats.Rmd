...
The first two sections are adapted from the Data Carpentry [R for data
analysis and
visualization](http://www.datacarpentry.org/R-ecology-lesson/index.html)
material.
...
![RStudio interface screenshot](figure/rstudio-screenshot.png)
...
![How it should look like at the beginning of this lesson](figure/r-starting-how-it-should-look-like.png)
...
![Example of a working directory structure](figure/working-directory-structure.png)
...
![RStudio help interface](figure/rstudiohelp.png)
